...
def compute_feature_importance_captum(
    ...
    Args:
        ...
        skip_plot (bool): If True, skip individual plotting.
    ...
    # Only plot if skip_plot is False
    if not skip_plot:
...
def compute_feature_importance(
    ...
    if method.lower() == "captum":
        return compute_feature_importance_captum(
            model, inputs, features, baseline, baseline_samples, target_idx, target_name, skip_plot
        )
    elif method.lower() == "shap":
        return compute_feature_importance_shap(
            model, inputs, features, baseline_samples, target_idx, target_name, skip_plot
        )
    else:
